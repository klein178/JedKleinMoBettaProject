...
Jed Klein's Code (built on top of what was given by Doctor Moshier)
December 13, 2017
Dr. Moshier
...
boolCalc (BBin op expr1 expr2)
  = liftA2 (opLookup op BinOpB) (boolCalc expr1) (boolCalc expr2)
boolCalc (BUn op expr)
  = fmap (opLookup op OneOpB) (boolCalc expr)

intCalc :: AExpr -> IntCalc
intCalc (Var v) = retrieveEnv v
intCalc (IntConst val) = return val
intCalc (ABin op expr1 expr2)
  = liftA2 (opLookup op BinOpA) (intCalc expr1) (intCalc expr2)
intCalc (AUn op expr)
  = fmap (opLookup op OneOpA) (intCalc expr)
