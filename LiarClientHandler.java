			...
			while (true)
			{
				...
				if (clientText != null)
				{
					...
					if (diQuant == 0 && diFace ==0)	
					{
						...
						for (Socket s : socketList)
						{
							if (player1Roll[0] + player1Roll[1] + player1Roll[2] + player1Roll[3] + player1Roll[4] == 0)
							{
								DataOutputStream output = new DataOutputStream(s.getOutputStream());
								output.writeBytes("G A M E  O V E R ! ! !\n\n  Please press 'Ctrl + C' to exit this game.\n");
							}
							if (player2Roll[0] + player2Roll[1] + player2Roll[2] + player2Roll[3] + player2Roll[4] == 0)
							{
								DataOutputStream output = new DataOutputStream(s.getOutputStream());
								output.writeBytes("G A M E  O V E R ! ! !\n\n  Please press 'Ctrl + C' to exit this game.\n");
							}
